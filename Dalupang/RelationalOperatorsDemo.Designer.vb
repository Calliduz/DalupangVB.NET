...
Partial Class RelationalOperatorsDemo
    ...
    Private Sub InitializeComponent()
        ...
        TextBox1.Size = New Size(704, 55)
        TextBox1.TabIndex = 10
        TextBox1.TabStop = False
        TextBox1.Text = "a programming language construct or operator that tests or defines some kind of relationship between two entities."
        ' 
        ' OutlinedLabel1
        ' 
        ...
        OutlinedLabel1.Size = New Size(592, 69)
        OutlinedLabel1.TabIndex = 9
        OutlinedLabel1.Text = "Relational Operators"
        ...
        Name = "RelationalOperatorsDemo"
        Text = "RelationalOperatorsDemo"
        ResumeLayout(False)
        PerformLayout()
    End Sub
